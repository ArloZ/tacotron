...
from .rnn_wrappers import DecoderPrenetWrapper, ConcatOutputAndAttentionWrapper, \
    ConcatOutputProjectionAndAttentionWrapper
...
class Tacotron():
    ...
    def initialize(self, inputs, input_lengths, mel_targets=None, linear_targets=None):
        ...
        with tf.variable_scope('inference') as scope:
            ...
            output_cell = ConcatOutputProjectionAndAttentionWrapper(
                OutputProjectionWrapper(decoder_cell, hp.num_mels * hp.outputs_per_step),
                concat_cell.get_attention_state())
